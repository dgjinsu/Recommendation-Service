...
import fastcampus.directionsService.direction.dto.InputDto;
import fastcampus.directionsService.pharmacy.service.PharmacyRecommendationService;
...
public class FormController {
    ...
    @PostMapping("/search")
    public ModelAndView postDirection(InputDto inputDto)  {
